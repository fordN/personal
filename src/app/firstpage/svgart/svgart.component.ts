...
export class SvgartComponent implements OnInit {
	...
	fullfilenames: { id: number, name: string, iterations: number, animateTo: string, textdate: string, prompt: string }[] = [{id:1, name: "assets/svg/101317.svg", iterations: 0, animateTo: 'rotate', textdate: 'October 13', prompt: 'bar chart inspired' },
